...
#warning - Customize NSPersistentStoreUbiquitousContentNameKey if you adapt this code to your own projects
...
- (void)mergeNoniCloudDataWithiCloud {
    ...
    [_seedContext performBlock:^{
        ...
        if ([self loadNoniCloudStoreAsSeedStore]) {
            ...
            NSArray *entitiesToCopy = [NSArray arrayWithObject:@"Test"];
...
#warning - Again, customize NSPersistentStoreUbiquitousContentNameKey if you adapt this code to your own projects
